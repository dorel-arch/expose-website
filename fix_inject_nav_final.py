#!/usr/bin/env python3
"""Inject desktop nav CSS into pages that still need it (checking specifically for .nav grid rule)."""
import os
...
# Specifically check for the nav CSS comment marker
CHECK_MARKER = '/* ── Desktop nav (≥ 900px) ── */'
